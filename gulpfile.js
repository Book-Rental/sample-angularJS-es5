...
gulp.task('build-bundle-css', function() {
  del.sync('./dist/css/bundle.min.css', {force: true});
...
gulp.task('build-vendor-css', function() {
  del.sync('./dist/css/vendor.min.css', {force: true});
...
gulp.task('build-fonts', function() {
  del.sync('./dist/fonts', {force: true});
...
gulp.task('build-images', function() {
  ...
  return mergedStream.pipe(gulp.dest('./dist/images/'));
});
...
gulp.task('build-clean-js-html', function(cb) {
  del.sync(['./dist/js/bundle.min.js',
    './dist/js/bundle.min.js.map'], {force: true});
...
gulp.task('build-clean-vendor-js', function(cb) {
  del.sync('./dist/js/vendor.min.js', {force: true});
